...
# ─────────────────────────────────────────────────────────────
# 2026-08-26: 하루 1회(오전 07시대)로 정리. 주 6일에 6주제를 한 번씩 배정해
# 6개 축이 매주 골고루 한 바퀴 돌게 한다(예전 심야 슬롯 주제가 죽지 않도록).
# evening 은 수동 실행(--slot evening)용으로만 남겨둔다.
SCHEDULE = {
    1: {"morning": 1, "evening": 3},  # 월: 운동
    2: {"morning": 2, "evening": 5},  # 화: 재테크
    3: {"morning": 4, "evening": 6},  # 수: 스트레스·수면
    4: {"morning": 3, "evening": 1},  # 목: 얼굴 피부
    5: {"morning": 5, "evening": 2},  # 금: 바디·두피
    6: {"morning": 6, "evening": 4},  # 토: 소소한 일상
}
